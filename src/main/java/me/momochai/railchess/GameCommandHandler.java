...
public class GameCommandHandler implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        try {
            ...
            if (args[1] == null || player == null || !player.isValid()) return false;
            String name = player.getName();
            if (!player.hasPermission("railchess.subscribe"))
                return false;
            if (Objects.equals(args[1], "spectate")) {
            ...
            } else if (Objects.equals(args[1], "despectate")) {
            ...
            } else if (Objects.equals(args[1], "quit")) {
